            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="size-8"
                                src="https://yvolve.shop/cdn/shop/products/NAR-0118--2.png?v=1725531522&width=1445"
                                alt="Your Company">
                        </div>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="size-8 rounded-full"
                                            src="https://yt3.ggpht.com/yti/ANjgQV-6-pKYyCfB-NKMyEBHTPbfwMpkN9vT5PI3lldGJU5jvMA=s88-c-k-c0x00ffffff-no-rj"
                                            alt="">
                                        <div class="ml-1">
                                            <div class="text-base/5 font-medium text-white" style="text-align: left">Ujjwal Karki</div>
                                            <div class="text-sm font-medium text-gray-400">
                                                ujjwalkarki.official@gmail.com</div>
                                        </div>
                                    </button>
                                </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Ujjwal Karki</div>
                            <div class="text-sm font-medium text-gray-400">ujjwalkarki.official@gmail.com</div>
                        </div>
                        <button type="button"
